                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            ...
                            <tr>
                                <td>会议室名称:</td>
                                <td>
                                    <input id="roomname" name="roomname" type="text" value="${mr.roomname}" maxlength="20"/>
                                </td>
                            </tr>
                            <tr>
                                <td>最多容纳人数：</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <#else>
                                        ...
                                        <input type="radio" id="status" name="status" checked="checked" value=1 /><label for="status">已占用</label>
                                    </#if>
                                </td>
                            </tr>
                            <tr>
